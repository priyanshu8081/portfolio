    ...
    <footer className="footer">
      <div className="container footer-inner">
        <div className="footer-brand">
          ...
          <p className="footer-tagline">MERN Stack Developer, based in Lucknow, India.</p>
        </div>
        ...
        <div className="footer-socials">
          <a href="https://github.com/priyanshu8081" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          ...
          <a href="https://linkedin.com/in/priyanshu-chauhan" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="mailto:pc0749711189@gmail.com" aria-label="Email">
      ...
      <div className="footer-bottom">
        <p>&copy; {year} Priyanshu Chauhan. All rights reserved.</p>
      </div>
    </footer>
  );
};
