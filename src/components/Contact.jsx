...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // submission — e.g. fetch('/api/contact', { method: 'POST', ... })
      ...
      <div className="container contact-grid">
        <div className="contact-info" data-reveal>
          ...
          <div className="contact-methods">
            <a href="mailto:pc0749711189@gmail.com" className="contact-method">
              ...
              <span>
                ...
                <span className="contact-method-value">pc0749711189@gmail.com</span>
              </span>
            </a>

            <a href="tel:+918081323513" className="contact-method">
              <span className="contact-method-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <span>
                ...
                <span className="contact-method-value">+91 8081323513</span>
              </span>
            </a>
            ...
            >
              ...
              <span>
                ...
                <span className="contact-method-value">linkedin.com/in/priyanshu-chauhan</span>
              </span>
            </a>
            ...
            >
              ...
              <span>
                ...
                <span className="contact-method-value">github.com/priyanshu8081</span>
              </span>
            </a>
          </div>
        </div>
        ...
        >
          ...
          {status === 'success' && (
            <p className="form-success" role="status">
              Thanks for reaching out! This form isn't wired to a backend yet —
              please also email me directly so I actually see your message.
            </p>
          )}
        </form>
      </div>
